...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sintype.lk — Singlish to Sinhala Unicode & FM Font Converter" },
      { name: "description", content: "Instantly convert Singlish typing into Sinhala Unicode or Legacy FM fonts. Voice input, mobile sync via QR, history — free productivity tool for Sri Lankan writers and designers." },
      ...
      { property: "og:title", content: "Sintype.lk — Sinhala Typing Reimagined" },
      { property: "og:description", content: "Singlish → Unicode & Legacy FM. Voice typing, mobile QR sync, instant copy." },
